...
@section("title") Dodaj jačinu kamere @endsection
@section("content")
    <div class="container-fluid">
        <h1 class="h3 text-center">Dodaj jačinu kamere</h1>
        ...
        <div class="container">
            <form action="{{route("camera.store")}}" method="POST">
                ...
                <table class="w-100 table">
                    ...
                    <tbody>
                    <tr>
                        <td><input type="text" class="form-control" placeholder="20.." name="cameraName"></td>
