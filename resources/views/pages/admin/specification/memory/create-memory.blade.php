...
@section("title") Dodaj memoriju @endsection
@section("content")
    <div class="container-fluid">
        <h1 class="h3 text-center">Dodaj memoriju</h1>
        ...
        <div class="container">
            <form action="{{route("memory.store")}}" method="POST">
                ...
                <table class="w-100 table">
                    ...
                    <tbody>
                    <tr>
                        <td><input type="text" class="form-control" placeholder="8 .." name="memoryName"></td>
